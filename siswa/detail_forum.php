<!-- SISWA: Detail Forum (Shared view same as guru but different back link) -->
<?php
$fid = $_GET['id'];
...
?>
<div class="card">
    <a href="dashboard.php?page=forum_siswa" class="btn" style="margin-bottom:15px;border:1px solid #ddd;color:#333;">← Kembali ke Forum</a>
    <h2>💬 <?=$thread['judul']?></h2>
...
<div class="card">
    ...
    <div style="border-left:4px solid var(--second);padding:10px 15px;margin-bottom:10px;border-radius:0 8px 8px 0;background:rgba(0,0,0,0.02);">
