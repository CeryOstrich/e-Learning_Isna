<?php
/**
 * views/admin/leaderboard.php — Papan Peringkat Global untuk Admin
 */
Auth::requireRole('admin');
$db  = Database::getInstance();

$board = Gamifikasi::getLeaderboard(0); // 0 = global

$pageTitle = '🏆 Leaderboard Global';
ob_start();
?>
...
<div style="margin-bottom:24px;">
    <h2 style="font-size:1.4rem; font-weight:800;">🌍 Papan Peringkat Global</h2>
    <p style="color:var(--text-muted); font-size:0.9rem; margin-top:4px;">Pantau skor gamifikasi seluruh siswa di sekolah.</p>
</div>
...
<?php if (empty($board)): ?>
    <div class="card" style="text-align:center; padding:60px 20px;">
        ...
        <p class="text-muted" style="margin-top:8px;">Belum ada siswa yang memiliki XP.</p>
    </div>
<?php else: ?>
    <!-- PODIUM TOP 3 -->
    <div class="card mb-6">
        <div style="text-align:center; margin-bottom:20px;">
            <span style="font-size:0.8rem; font-weight:700; text-transform:uppercase; letter-spacing:0.08em; color:var(--text-muted);">Top 3 Peraih XP Terbanyak Sekolah</span>
        </div>
